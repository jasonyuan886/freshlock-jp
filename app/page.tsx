    ...
    <section id="about" className="py-20 bg-white" aria-labelledby="about-heading">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-4">
          ...
          <p>
            <strong>専用袋不要</strong>で、市販のエンボス加工・片一方向バルブ付きチャック袋（90μm以上推奨）に幅広く対応。USB-Cで約2.5時間フル充電、1回の充電で約80〜100回吸引でき、運転音は約60dBと<strong>音が静か</strong>。コンパクトな約210gで引き出しにもすっきり収まります。本体1年保証・付属品6ヶ月保証で安心して長くお使いいただけます。
          </p>
        </article>
      </div>
    </section>
...
const featureList = [
  ...
  {
    icon: '🫙',
    title: 'メイソンジャー・保存容器にも対応',
    text: 'ノズルはバルブ穴φ33mm以下・平らな接地面φ40mm以上に対応。バルブ付きのフタなら、メイソンジャーや保存容器でも袋と同じ操作でそのまま真空保存できます（平らな一般的なフタは非対応）。',
  },
  {
    icon: '👆',
    title: '片手でワンタッチ',
  ...
  },
  {
    icon: '🛡️',
    title: '本体1年保証',
    text: 'お買い上げ日から本体は1年、付属品は6ヶ月の保証付き。BPAフリー素材を採用し、FCC・CE・RoHS相当の設計基準を満たしています。',
  },
];
