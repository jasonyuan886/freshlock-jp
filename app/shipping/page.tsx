  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-lg max-w-none">
        <h2>配送エリア</h2>
        <p>現在、日本全国（沖縄・離島を含む）に配送しております。海外への配送は現在対応しておりません。</p>

        <h2>ご注文の処理</h2>
        <p>ご注文は土日祝日を除く1〜2営業日以内に発送手配いたします。営業日14時以降のご注文は翌営業日の処理となります。</p>
          ...
          <table className="w-full border-collapse border border-gray-300 my-4">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border border-gray-300 px-4 py-2 text-left">お届け日数</th>
                <th className="border border-gray-300 px-4 py-2 text-left">送料</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-gray-300 px-4 py-2">通常配送</td>
                <td className="border border-gray-300 px-4 py-2">3〜7営業日</td>
                <td className="border border-gray-300 px-4 py-2">5,000円以上で送料無料<br />5,000円未満は全国一律550円</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2">速達配送</td>
                <td className="border border-gray-300 px-4 py-2">1〜3営業日</td>
                <td className="border border-gray-300 px-4 py-2">全国一律1,200円</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p>※天候・交通事情・配送業者の都合により、お届けが遅れる場合がございます。あらかじめご了承ください。</p>

        <h2>送料無料</h2>
        <p>商品合計金額が<strong>5,000円（税込）以上</strong>の場合、全国どこでも<strong>通常配送料無料</strong>となります。チェックアウト時に自動適用されます。</p>
