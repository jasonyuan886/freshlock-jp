...
const description =
  ...
  'FreshLock（フレッシュロック）公式サイト。片手でワンタッチのコードレス式ハンディ真空ポンプ。-60kPa吸引力・USB-C充電・着脱式汁受けで汁物対応・専用袋不要・BPAフリー・音が静か。作り置き・離乳食の小分け冷凍・冷凍焼け防止に。¥5,500以上のご注文で送料無料対応、7日間返品保証、本体1年保証、本体1年保証。';
