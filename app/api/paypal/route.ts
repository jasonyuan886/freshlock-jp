  ...
  try {
    ...
    const paypalOrder = await fetch(`${PAYPAL_BASE_URL}/v2/checkout/orders`, {
      ...
      body: JSON.stringify({
        ...
        application_context: {
          brand_name: 'FreshLock Japan',
          landing_page: 'NO_PREFERENCE',
          user_action: 'PAY_NOW',
          return_url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://jp.freshlocksealer.com'}/checkout/success?payment_method=paypal`,
          cancel_url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://jp.freshlocksealer.com'}/checkout`,
        },
      }),
    });
