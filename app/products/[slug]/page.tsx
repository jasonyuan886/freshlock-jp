  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <nav className="text-sm text-gray-500 mb-8">
        ...
        <Link href="/products" className="hover:text-primary">製品一覧</Link>
        <span className="mx-2">/</span>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          {/* Features */}
          <div className="mb-8">
            <h3 className="font-semibold text-primary mb-3">主な特長</h3>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <h3 className="font-semibold text-primary mb-3">仕様</h3>
      ...
      {related.length > 0 && (
        <div className="mt-20">
          <h2 className="section-title mb-8">関連製品</h2>
